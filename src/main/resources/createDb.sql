...
INSERT into CUSTOMER values (1, 'atm', 32, 1000, 2000);
INSERT into CUSTOMER values (2, 'rbs', 25, 23, 1500);
INSERT into CUSTOMER values (3, 'hsbc', 23, 7, 2000);
INSERT into CUSTOMER values (4, 'pko', 25, 3, 6500);
